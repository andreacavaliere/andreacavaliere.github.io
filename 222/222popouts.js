...
function showDetailedView(currentDiv, firstname, lastname, imagepath, imagename) {
	var popframe = document.getElementById(currentDiv);
    popping = popframe.id;
	popframe.id = "popout";
	popframe.innerHTML = "<br /><TABLE><TR><TH rowspan='3'><img src='" + imagepath + "' width='250'><TH align='left'>Artist's Name: <TH align='left'>" + 
